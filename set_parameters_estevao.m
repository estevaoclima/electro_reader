...
% LOAD PARAMS 
par.segments_length = 0.0000198%5;             % length (in minutes) of segments in which the data is cutted (default 5min). 
par.sr = 32000;                      % sampling rate (in Hz). This parameter will be only used if the data file don't have a sr. 
 
 
% PLOTTING PARAMETERS 
par.cont_segment = false%%ESTEVAO true;          %%%% 
...
par.w_pre = 14%20%%%%%%%   ESTEVAO;              % number of pre-event data points stored (default 20) 
par.w_post = 24% 44; %%%%%%% ESTEVAO            % number of post-event data points stored (default 44)) 
par.alignment_window = 14%10;           % number of points around the sample expected to be the maximum 
